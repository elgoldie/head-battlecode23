...
public class HeadquartersAI extends RobotAI {
    ...
    public void run() throws GameActionException {
        ...
        // boolean canSpawnCarrier = rc.getResourceAmount(ResourceType.MANA) >= RobotType.CARRIER.buildCostAdamantium;
        boolean canSpawnLauncher = rc.getResourceAmount(ResourceType.MANA) >= RobotType.LAUNCHER.buildCostMana;
        if (canSpawnLauncher) {
            typeToSpawn = RobotType.LAUNCHER;
        }
        
        if (rc.getRoundNum() >= 100 && rng.nextBoolean()) {
